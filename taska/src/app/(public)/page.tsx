  ...
  return (
    <main className="mx-auto max-w-5xl px-6">
      ...
      <section className="grid items-start gap-12 py-14 md:grid-cols-2">
        <div>
          ...
          <ul className="mt-6 space-y-2.5 text-sm text-ink">
            <li>📋 Drag-and-drop pipeline board with enforced stage rules</li>
            <li>🔥 Automatic lead scoring from value, priority, source, and recency</li>
            <li>🧾 Append-only activity trail — every change, timestamped, forever</li>
            <li>🔐 Admin and member roles, enforced in the UI and the API</li>
          </ul>
        </div>
      ...
      <section className="border-t border-line py-14">
        <h2 className="text-2xl font-bold">📎 Embed the form on any website</h2>
      ...
      <section className="border-t border-line py-14">
        <h2 className="text-2xl font-bold">🔑 Reviewing this build?</h2>
